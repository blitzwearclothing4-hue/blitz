  ...
  const sendEmailNotification = async (orderData) => {
    try {
      const templateParams = {
        to_email: "raza.softwarearchitect@gmail.com",
        ...
        order_items: cartItems
          .map(
            (item) =>
              `Article: ${item.article} | ${item.name} | Size: ${item.size} | Qty: ${item.quantity} | $${(
        ...
        <div className="flex">
          ...
          <div className="flex-1 p-8">
            <div className="flex justify-between items-center mb-8">
              <h1 className="text-2xl font-bold text-black">BLITZWEAR</h1>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-6 text-black">
              ...
              <div>
                <input
                  ...
                  required
                  className="w-full border border-gray-300 rounded-md px-3 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-black"
                />
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <input
                      ...
                      onChange={handleInputChange}
                      className="border border-gray-300 rounded-md px-3 py-3 text-black focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    />
                    <input
                      type="text"
                      name="lastName"
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full border border-gray-300 rounded-md px-3 py-3 text-black focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
              ...
              {/* Payment */}
              <div>
                <h2 className="text-lg font-semibold mb-2 text-black">Payment</h2>
                <p className="text-sm text-gray-600 mb-4">
                  All transactions are secure and encrypted.
                </p>
                <div className="bg-gray-50 p-4 rounded-md text-center text-black">
          ...
          <div className="w-80 bg-gray-50 p-6 text-black">
            <div className="space-y-4">
              {cartItems.map((item) => (
              ...
              <div className="border-t pt-4 space-y-2">
                ...
                <div className="flex justify-between font-bold text-lg border-t pt-2">
                  <span>Total</span>
                  <span>
                    <span className="text-sm text-gray-500 mr-1">USD</span>${total.toFixed(2)}
                  </span>
                </div>
              </div>
            </div>
